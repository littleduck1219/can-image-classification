    ...
    while True:
        ...
        if not ref:
            ...
            if push_btn:                            # 버튼을 눌렀을때(화면을 끄면)
                ...
                cv2.putText(frame, '%s' % (show_res), (360, 60), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 3)
                cv2.putText(frame, '{}'.format(show_score), (380, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0),
                            2)  # 수정한거
